...
for start in buttons:
    for goal in buttons:
        ...
        toTest = Queue()
        alreadyVisited = []
        toTest.put(( 'A' ,start, 0))
        toTest.put(( 'v' ,start, 0))
        toTest.put(( '<' ,start, 0))
        toTest.put(( '>' ,start, 0))
        toTest.put(( '^' ,start, 0))
...
for i in range(24):
    ...
    for start in buttons:
        for goal in buttons:
            ...
            alreadyVisited = []
            toTest.put((costPrevious[('A', 'A')], 'A' , start))
            toTest.put((costPrevious[('A', 'v')],  'v' , start))
            toTest.put((costPrevious[('A', '<')], '<' , start))
            toTest.put((costPrevious[('A', '>')], '>' , start))
            toTest.put((costPrevious[('A', '^')], '^' , start))
            ...
            while not found:
                ...
                if node[2] == goal and node[1] == 'A':
                    ...
                    if newPos:
                        toTest.put( (node[0]+costPrevious[(node[1], 'A')], 'A' ,newPos))
                        toTest.put( (node[0]+costPrevious[(node[1], 'v')], 'v' ,newPos))
                        toTest.put( (node[0]+costPrevious[(node[1], '<')], '<' ,newPos))
                        toTest.put( (node[0]+costPrevious[(node[1], '>')], '>' ,newPos))
                        toTest.put( (node[0]+costPrevious[(node[1], '^')], '^' ,newPos))
